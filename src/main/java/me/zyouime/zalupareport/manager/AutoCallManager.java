...
public class AutoCallManager {
    ...
    private void handlePt(int sec) {
        ...
        else{msg("\u0418\u0433\u0440\u043e\u043a \u0430\u0444\u043a \u043f\u0440\u043e\u0441\u043b\u0435\u0434\u0438\u0442\u0435 \u0441\u0430\u043c\u0438");state=State.CLOSING_STEP1;delay(this::close1,1000);}
    }
    ...
    private void close3(){if(client.player==null||client.player.currentScreenHandler==null){state=State.IDLE;return;}client.interactionManager.clickSlot(client.player.currentScreenHandler.syncId,16,0,SlotActionType.PICKUP,client.player);delay(()->{chat("-");state=State.REOPENING;delay(this::reopen,1500);},500);}
    private void reopen(){foundAny=false;cmd("reportlist");delay(()->{state=State.SEARCHING;search();},1500);}
